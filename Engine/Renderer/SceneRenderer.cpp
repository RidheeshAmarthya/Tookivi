...
namespace Tookivi {
	...
	Tookivi::FramebufferSpecification SceneRenderer::GetMainFrameSpec()
	{
		return s_Data.geoPass->GetSpecification().TargetFrameBuffer->GetSpecification();
	}

	Tookivi::Ref<Tookivi::FrameBuffer> SceneRenderer::GetGeoFrameBuffer()
	{
		return s_Data.geoPass->GetSpecification().TargetFrameBuffer;
	}

	Tookivi::ShaderLibrary& SceneRenderer::GetShaderLibrary()
	{
