...
namespace Tookivi {
	...
	Tookivi::Ref<Tookivi::Entity> Scene::CreateLight(LightType type)
	{
		auto ent = this->CreateEntity();
		std::string path;
		Ref<Light> light;
		switch (type)
		{
		case Tookivi::LightType::Directional:
